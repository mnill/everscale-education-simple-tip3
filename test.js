...
async function main(client) {
    try {
        ...
        try {
            ...
            assert((e.data.exit_code || e.data.local_error.data.exit_code) === 102, "Call unsuccessful. Necessary to set _deploy_evers to more then 0.1 ton")
        }
        ...
        try {
            ...
            assert((e.data.exit_code || e.data.local_error.data.exit_code) === 103, "Call unsuccessful. Necessary to fulfill balance to pass address(this).balance > start_gas_balance + _deploy_evers check")
        }
